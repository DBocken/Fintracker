...
/**
 * Vollständiger Profil-Inhalt (Theme, Sanfter Modus, Beta-/Premiumzugang,
 * Einstellungen, Logout). Bewusst ohne eigenen Dialog/Trigger, damit genau
 * EIN Profil-Einstieg (oben rechts, {@link UserQuickProfile}) diesen Inhalt
 * öffnet — vorher gab es ein zweites, identisches Profil in der Sidebar.
 */
