  ...
  return (
    <div data-tour-id="split-panel" className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        {isSaved && (
          <Button
            variant="ghost"
            size="sm"
            className="h-7 text-xs text-destructive hover:text-destructive pointer-coarse:min-h-11"
      ...
      <Button
        variant="ghost"
        size="sm"
        className="h-7 w-full border border-dashed border-border text-xs pointer-coarse:min-h-11"
