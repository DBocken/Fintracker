      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <label className="flex flex-col gap-1 text-sm">
          ...
          <Select value={String(months)} onValueChange={(v) => setMonths(Number(v))}>
            <SelectTrigger className="h-10 w-full pointer-coarse:min-h-11" aria-label={t("liquidityReport.horizonLabel")}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <label className="flex flex-col gap-1 text-sm">
          ...
          <Select value={String(safetyBuffer)} onValueChange={(v) => setSafetyBuffer(Number(v))}>
            <SelectTrigger className="h-10 w-full pointer-coarse:min-h-11" aria-label={t("liquidityReport.bufferLabel")}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <label className="flex flex-col gap-1 text-sm">
          ...
          <Select value={bufferBasis} onValueChange={(v) => setBufferBasis(v as BufferBasis)}>
            <SelectTrigger className="h-10 w-full pointer-coarse:min-h-11" aria-label={t("liquidityReport.basisLabel")}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
