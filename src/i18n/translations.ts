...
export const translations = {
  de: {
    ...
    dashboard: {
      ...
      toAccount: 'Zu Konto',
      filterAccountAria: 'Konto filtern',
      allAccounts: 'Alle Konten',
      budgetPool: 'Budget-Pool',
      filterCategoryAria: 'Kategorie filtern',
      allCategories: 'Alle Kategorien',
      filterContractAria: 'Vertragsstatus filtern',
      contracts: 'Verträge',
      all: 'Alle',
      contractsOnly: 'Nur Verträge',
      withoutContracts: 'Ohne Verträge',
      essential: 'Essenziell',
      filterEssentialAria: 'Essenziell-Status filtern',
      essentialOnly: 'Nur essenziell',
      notEssential: 'Nicht essenziell',
      expenseClass: 'Ausgabenklasse',
      filterClassAria: 'Ausgabenklasse filtern',
      allClasses: 'Alle Klassen',
      classDiscretionary: 'Nicht-Essenziell',
      classSavings: 'Sparen',
      classIncome: 'Einkommen',
      uncategorized: 'Unkategorisiert',
      timeRange: 'Zeitraum',
      filterRangeAria: 'Zeitraum filtern',
      period: 'Periode',
      selectPeriodAria: 'Periode auswählen',
      selectPeriodPlaceholder: 'Periode wählen…',
      noData: 'Keine Daten',
      days: 'Tage',
      granularity: 'Granularität',
      granularityAria: 'Diagramm-Granularität auswählen',
      daily: 'Täglich',
      weekly: 'Wöchentlich',
      monthly: 'Monatlich',
      searchLabel: 'Suche',
      searchTransactions: 'Transaktionen suchen',
      // Anzeige-Labels der Zeitraum-Optionen; die Werte selbst bleiben stabil
      // (State/URL), übersetzt wird nur die Beschriftung.
      ranges: {
        total: 'Gesamt',
        year: 'Jahr',
        quarter: 'Quartal',
      ...
      assign: 'Zuweisen',
      deselect: 'Abwählen',
      coachCardAria: 'Zum nächsten Schritt – zum Coach',
      coachCardText: 'Detailansicht für Charts & Transaktionen. Deine nächste Aktion zeigt dir der Coach.',
      filter: 'Filter',
      ...
      showAllTransactions: 'Alle Buchungen anzeigen',
      showAllPrefix: 'Alle',
      showAllSuffix: 'Buchungen anzeigen',
      noTransactionsFound: 'Keine Transaktionen gefunden',
      noTransactionsFoundHint: 'Prüfe Filter, Suchbegriff oder lade die Daten neu, falls der Cache veraltet ist.',
      reload: 'Erneut laden',
      noTransactionsYet: 'Keine Transaktionen vorhanden',
      noTransactionsYetHint: 'Importiere eine CSV-Datei, verbinde eine Bank oder lade nach einem Sync erneut.',
      importCsv: 'CSV importieren',
      connectBank: 'Bank verbinden',
      transactionDetails: 'Transaktionsdetails',
      dataQualityTitle: 'Prognose eingeschränkt',
      dataQualityBody: 'Die Vorschau basiert auf veralteten oder unvollständigen Kontodaten. Synchronisiere die folgenden Konten für eine genauere Prognose:',
      andPrefix: '… und',
      andMoreOne: 'weiteres Konto',
      andMoreMany: 'weitere Konten',
    },
    transactions: {
      title: 'Buchungen',
  ...
  en: {
    ...
    dashboard: {
      ...
      filterAccountAria: 'Filter by account',
      allAccounts: 'All accounts',
      budgetPool: 'Budget pool',
      filterCategoryAria: 'Filter by category',
      allCategories: 'All categories',
      filterContractAria: 'Filter by contract status',
      contracts: 'Contracts',
      all: 'All',
      contractsOnly: 'Contracts only',
      withoutContracts: 'Without contracts',
      essential: 'Essential',
      filterEssentialAria: 'Filter by essential status',
      essentialOnly: 'Essential only',
      notEssential: 'Not essential',
      expenseClass: 'Spending class',
      filterClassAria: 'Filter by spending class',
      allClasses: 'All classes',
      classDiscretionary: 'Non-essential',
      classSavings: 'Savings',
      classIncome: 'Income',
      uncategorized: 'Uncategorized',
      timeRange: 'Time range',
      filterRangeAria: 'Filter by time range',
      period: 'Period',
      ...
      granularityAria: 'Select chart granularity',
      daily: 'Daily',
      weekly: 'Weekly',
      monthly: 'Monthly',
      searchLabel: 'Search',
      ...
      assign: 'Assign',
      deselect: 'Deselect',
      coachCardAria: 'Your next step – open the coach',
      coachCardText: 'Detail view for charts & transactions. The coach shows your next action.',
      filter: 'Filters',
      resetFilters: 'Reset filters',
      cashflowTitle: 'Cash flow at a glance',
      cashflowDescription: 'Your money flow at main-category level. Find the subcategory drilldown in the analysis area.',
      recentTransactions: 'Recent transactions',
      showAllTransactions: 'Show all transactions',
      showAllPrefix: 'Show all',
      showAllSuffix: 'transactions',
      noTransactionsFound: 'No transactions found',
      noTransactionsFoundHint: 'Check the filters or search term, or reload if the cache is stale.',
      reload: 'Reload',
      noTransactionsYet: 'No transactions yet',
      noTransactionsYetHint: 'Import a CSV file, connect a bank, or reload after a sync.',
      importCsv: 'Import CSV',
      connectBank: 'Connect bank',
      transactionDetails: 'Transaction details',
      dataQualityTitle: 'Forecast limited',
      dataQualityBody: 'The preview is based on outdated or incomplete account data. Sync the following accounts for a more accurate forecast:',
      andPrefix: '… and',
      andMoreOne: 'more account',
      andMoreMany: 'more accounts',
    },
    transactions: {
      title: 'Transactions',
