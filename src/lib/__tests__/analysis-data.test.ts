...
import { buildSpendingSunburst, buildSunburstBreakdown, buildSunburstTree, resolveAusgabenklasse, sumIncome, sumExpenses, buildIncomeBreakdown, buildIncomeOverTime } from '../analysis-data';
