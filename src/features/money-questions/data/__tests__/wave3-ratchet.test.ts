...
/**
 * Die Ratsche der Welle 3 — Konten, Vermögen, Depots, Anlässe, Transfers,
 * Steuer.
 *
...
describe('Welle-3-Ratsche', () => {
  const ausgaenge = WELLE3_KORPUS.map((zeile) => ({
    ...zeile,
  ...
  it('sollte den vollständigen Welle-3-Korpus vermessen', () => {
    expect(WELLE3_KORPUS.length).toBeGreaterThanOrEqual(25);
  });
