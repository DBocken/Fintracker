...
import { financeKeys } from '../../data/finance-query-keys';
import {
...
import { dashboardKeys } from '@/features/dashboard/data/dashboard-query-keys';
...
describe('shared Re-Export-Integrität', () => {
  ...
  it('[REGRESSION] sollte dashboardKeys als dasselbe Objekt wie financeKeys bereitstellen', () => {
    ...
    expect(dashboardKeys.transactionsAll).toBe(financeKeys.transactionsAll);
  });
});
