...
SET filters = (
  SELECT jsonb_agg(DISTINCT value)
  FROM jsonb_array_elements(filters || to_jsonb(ARRAY['versicherung', 'allianz', 'huk-coburg', 'huk24', 'huk coburg', 'axa', 'ergo', 'debeka', 'signal iduna', 'generali', 'wgv', 'devk', 'gothaer', 'barmenia', 'hanse merkur', 'württembergische', 'wuerttembergische', 'cosmosdirekt', 'verti versicherung', 'alte leipziger', 'ottonova', 'zurich versicherung', 'ihre versicherung', 'r+v versicherung', 'ruv', 'lvm versicherung', 'vhv', 'continentale', 'nürnberger versicherung', 'nuernberger versicherung', 'beitrag versicherung', 'haftpflicht']))
)
...
SET filters = (
  SELECT jsonb_agg(DISTINCT value)
  FROM jsonb_array_elements(filters || to_jsonb(ARRAY['netflix', 'spotify', 'amazon prime', 'disney+', 'disneyplus', 'apple.com/bill', 'apple.com bill', 'youtube premium', 'dazn', 'sky deutschland', 'wow tv', 'rtl+', 'rtl plus', 'joyn', 'audible', 'paramount+', 'paramount plus', 'deezer', 'tidal', 'crunchyroll', 'rundfunk', 'abo', 'abonnement', 'adobe', 'microsoft 365', 'office 365', 'icloud', 'google one', '1&1', '1und1', 'telekom', 'vodafone', 'o2', 'congstar', 'freenet', 'fitness abo', 'zeitschriftenabo', 'zeitungsabo', 'tagesspiegel abo', 'spiegel plus', 'patreon', 'onlyfans']))
)
